    function IconUpload({width="2.6rem",height="2.6rem",className=""}) {
        console.log("classname")
        return (  
            <svg className={className} width={width} data-e2e="" height={height}viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
